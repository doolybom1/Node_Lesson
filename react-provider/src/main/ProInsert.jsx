...
class ProInsert extends Component {
    ...
    // 키보드에서 입력을 하면 입력받은 문자열을 this.state.message에 저장해달라
    ...
    // Main에서 Sub2를 통해서 전달된 changeMessage 메서드를 호출하여 지금부터 내가 보내는 문자열을 전체 컴포넌트가
        ...
        return (
            <div>
               ...
               {/* 
                    ...
                    1. value에 포함시킬 state 변수를 선언하고
                    2. value={this.state.변수}라고 작성하고
                    3. onChange 이벤트를 캡춰하여 키보드에서 입력된 문자열을 this.state.변수에 반영(this.setState)시킨다
               */}
